            ...
            Column(
              children: [
                _documentTile(
                  ...
                  docType: 'license_document_front',
                  title: 'Driving License (Front)',
                  docUrl: controller.licenseDocFront.value,
                  icon: Icons.badge_outlined,
                ),
                const Gap(height: 12),
                _documentTile(
                  controller: controller,
                  docType: 'license_document_back',
                  title: 'Driving License (Back)',
                  docUrl: controller.licenseDocBack.value,
                  icon: Icons.badge_outlined,
                ),
                const Gap(height: 12),
                _documentTile(
                  controller: controller,
                  docType: 'id_document_front',
                  title: 'ID Document (Front)',
                  docUrl: controller.idDocFront.value,
                  icon: Icons.credit_card_outlined,
                ),
                const Gap(height: 12),
                _documentTile(
                  controller: controller,
                  docType: 'id_document_back',
                  title: 'ID Document (Back)',
                  docUrl: controller.idDocBack.value,
                  icon: Icons.credit_card_outlined,
                ),
                const Gap(height: 12),
                _documentTile(
