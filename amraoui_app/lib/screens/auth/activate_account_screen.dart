        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: const Icon(Icons.mark_email_read_outlined, size: 48, color: Color(0xFF2563EB)),
            ),
            const Gap(height: 40),
            const AppText(
            ...
            Row(
              ...
              children: [
                const AppText(data: "Didn't receive the code? ", color: Color(0xFF64748B), fontSize: 14),
                GestureDetector(
