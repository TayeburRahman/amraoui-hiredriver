          ...
          <table className="w-full text-left border-collapse min-w-[800px]">
            <thead>
              <tr className="border-b border-slate-100 bg-slate-50/50">
                <th className="py-5 px-6 sm:px-8 text-xs font-black text-slate-400 tracking-wider w-[20%]">
                  Mission ID
                </th>
                <th className="py-5 px-6 sm:px-8 text-xs font-black text-slate-400 tracking-wider w-[30%]">
                  Vehicle
                </th>
                ...
                <th className="py-5 px-6 sm:px-8 text-xs font-black text-slate-400 tracking-wider w-[20%] text-right">
                  Action
                </th>
              </tr>
            </thead>
