  ...
  return (
    <div className="max-w-[1400px] mx-auto p-4 md:p-8 lg:p-12 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="space-y-4">
        ...
        <h1 className="text-3xl md:text-4xl font-black text-brand-text">Hire a Driver</h1>
        <p className="text-slate-500 font-medium">Book professional drivers for your needs.</p>
      </div>
      ...
      <Card className="p-12 rounded-[2rem] border-none shadow-sm bg-white flex flex-col items-center justify-center text-center space-y-6">
        <div className="h-24 w-24 rounded-3xl bg-cyan-50 flex items-center justify-center">
          <UserCog className="h-12 w-12 text-cyan-500" />
        </div>
        <div className="space-y-2">
          <h2 className="text-2xl font-bold text-slate-900">Coming Soon</h2>
          <p className="text-slate-500 max-w-md">The Driver Hire service is currently under development. Stay tuned for updates!</p>
        </div>
