...
class CustomerSignatureScreen extends StatefulWidget {
  ...
  @override
  State<CustomerSignatureScreen> createState() => _CustomerSignatureScreenState();
}
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              AppText(
                data: widget.isDelivery ? 'Receiver Signature' : 'Customer Signature',
                fontSize: 24,
              ...
              const Gap(height: 4),
              AppText(
                data: widget.isDelivery ? 'Get receiver confirmation' : 'Get customer confirmation',
                fontSize: 14,
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: AppText(data: widget.isDelivery ? 'Receiver Name' : 'Customer Name', fontSize: 16, fontWeight: FontWeight.bold, color: const Color(0xFF0F172A)),
                    ),
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: widget.isDelivery ? 'Enter receiver full name' : 'Enter customer full name',
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          const AppText(data: 'Signature', fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF0F172A)),
                          GestureDetector(
                            onTap: () {
                            ...
                            child: Row(
                              children: const [
                                Icon(Icons.refresh, color: Color(0xFF06B6D4), size: 16),
                                Gap(width: 4),
                                AppText(data: 'Clear', color: Color(0xFF06B6D4), fontSize: 14, fontWeight: FontWeight.w600),
                              ],
                            ),
                          ),
                        ],
              ...
              Container(
                ...
                child: AppText(
                  data: widget.isDelivery ? 'Receiver confirms vehicle condition at delivery.' : 'Customer confirms vehicle condition at pickup.',
                  fontSize: 14,
                  fontWeight: FontWeight.w500,
          ...
          child: ElevatedButton(
            ...
            onPressed: () async {
              if (_nameController.text.isEmpty) {
                Get.snackbar('Required', widget.isDelivery ? 'Please enter receiver name' : 'Please enter customer name', backgroundColor: Colors.red.withOpacity(0.9), colorText: Colors.white, snackPosition: SnackPosition.bottom, margin: const EdgeInsets.all(20));
                return;
              }
              if (_signatureController.isEmpty && savedSignatureUrl == null) {
                Get.snackbar('Required', 'Please provide a signature', backgroundColor: Colors.red.withOpacity(0.9), colorText: Colors.white, snackPosition: SnackPosition.bottom, margin: const EdgeInsets.all(20));
                return;
              }
              ...
              try {
                ...
                if (_signatureController.isNotEmpty) {
                  ...
                  if (signatureBytes != null) {
                    files.add(MultipartFile.fromBytes(signatureBytes, filename: 'signature.png'));
                ...
                if (res.statusCode == 200) {
                  ...
                  final savedData = res.data['data']['details'][inspectionKey]['customerSignature'];
                  widget.mission['details'][inspectionKey]['customerSignature'] = savedData;
            ...
            child: Ink(
              ...
              child: Container(
                ...
                child: const AppText(data: 'Save Signature', color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15),
              ),
            ),
          ),
        ),
