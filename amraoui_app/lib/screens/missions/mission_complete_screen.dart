                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (type == 'TRANSPORT') ...[
                      ...
                      _buildSummaryRow('Pickup Date', '${_formatDate(detailsObj['pickupDate'])} ${detailsObj['pickupTime'] != null && detailsObj['pickupTime'].toString().trim().isNotEmpty && detailsObj['pickupTime'].toString() != 'null' ? detailsObj['pickupTime'] : ''}'.trim()),
                      _buildSummaryRow('Dropoff Date', '${_formatDate(detailsObj['dropoffDate'])} ${detailsObj['dropoffTime'] != null && detailsObj['dropoffTime'].toString().trim().isNotEmpty && detailsObj['dropoffTime'].toString() != 'null' ? detailsObj['dropoffTime'] : ''}'.trim()),
