...
class _MileageFuelScreenState extends State<MileageFuelScreen> {
  ...
  void initState() {
    ...
    if (widget.existingData != null) {
      _mileageController.text = (widget.existingData!['mileage'] ?? '')
          .toString();
            ...
            children: [
              ...
              Row(
                ...
                children: fuelOptions
                    .map((option) => _buildFuelOption(option))
                    .toList(),
              ),
            ...
            onPressed: () async {
              ...
              if (fuelLevel != 'Empty') {
                ...
                if (fuelGaugePhoto == null) {
                  Get.snackbar(
                    'Required',
                    'Please capture fuel gauge photo',
                    backgroundColor: Colors.red.withOpacity(0.9),
                    colorText: Colors.white,
                    snackPosition: SnackPosition.bottom,
                    margin: const EdgeInsets.all(20),
              ...
              try {
                ...
                if (fuelLevel != 'Empty') {
                  if (odometerPhoto != null) {
                    bool isNetOdo =
                        odometerPhoto!.startsWith('http') &&
                        !odometerPhoto!.startsWith('blob:http');
                    if (!isNetOdo) {
                  ...
                  if (fuelGaugePhoto != null) {
                    bool isNetFuel =
                        fuelGaugePhoto!.startsWith('http') &&
                        !fuelGaugePhoto!.startsWith('blob:http');
                    if (!isNetFuel) {
                      final bytes = await FlutterImageCompress.compressWithFile(
                        fuelGaugePhoto!,
                        minWidth: 800,
                      ...
                      if (bytes != null) {
                        files.add(
                          MultipartFile.fromBytes(bytes, filename: 'fuel.jpg'),
                        );
                ...
                if (res.statusCode == 200) {
                  ...
                  final savedData = res
                      .data['data']['details'][inspectionKey]['mileageAndFuel'];
                  widget.mission['details'][inspectionKey]['mileageAndFuel'] =
                      savedData;
