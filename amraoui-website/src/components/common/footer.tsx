        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-blue-50/70">
              <li><Link href="/#solutions" className="hover:text-white transition-colors">{t.landing.solutions.badge}</Link></li>
              <li><Link href="/#become-driver" className="hover:text-white transition-colors">{t.common.becomeDriver}</Link></li>
              <li><Link href="/#solutions" className="hover:text-white transition-colors">Transportation with professional driver</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-blue-50/70">
              ...
              <li><Link href="/register" className="hover:text-white transition-colors">Make an appointment</Link></li>
              <li><Link href="/login" className="hover:text-white transition-colors">Transport tracking</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-blue-50/70">
              ...
              <li><Link href="/#why-choose" className="hover:text-white transition-colors">{t.common.whoAreWe}</Link></li>
              <li><Link href="/#contact" className="hover:text-white transition-colors">{t.landing.contact.title}</Link></li>
