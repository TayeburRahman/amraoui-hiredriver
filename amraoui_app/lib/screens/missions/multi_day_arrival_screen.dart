...
class _MultiDayArrivalScreenState extends State<MultiDayArrivalScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final pLocation = details['driverLocation'] ?? details['driverCity'] ?? 'Unknown Location';
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        const Gap(width: 8),
                        const AppText(data: 'Client Location', fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF0F172A)),
                      ],
                    ),
                    const Gap(height: 16),
              ...
              ...days.map((date) {
                ...
                final verifiedAt = hasArrived && existingArrival['verifiedAt'] != null 
                    ? DateFormat('HH:mm').format(DateTime.parse(existingArrival['verifiedAt']))
                    : '';
                  ...
                  child: Row(
                    ...
                    children: [
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          AppText(data: displayDate, fontSize: 15, fontWeight: FontWeight.bold, color: const Color(0xFF0F172A)),
                          if (hasArrived) ...[
                            const Gap(height: 4),
                            AppText(data: 'Arrived at $verifiedAt', fontSize: 13, color: const Color(0xFF10B981)),
                          ]
                        ],
                      ),
                      if (hasArrived)
                ...
                child: ElevatedButton(
                  ...
                  child: Ink(
                    ...
                    child: Container(
                      ...
                      child: const AppText(data: 'Complete Mission', color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15),
                    ),
                  ),
                ),
              ),
